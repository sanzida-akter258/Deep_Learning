...
class CNN(object):
    ...
    def __init__(
        ...
        # Create the multiple convolutional layers
        ...
        # calculate the output with for each layer
         
        output_width = input_width
        for i in range(self.nlayers):
            output_width = output_width - kernel_sizes[i] + 1          # conv (valid, stride 1)
            output_width = int(np.ceil(output_width / strides[i]))     # downsample by stride
